    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty_per_item', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='Quantity per item')),
                ...
                ('assigned_to', models.ManyToManyField(blank=True, null=True, related_name='process_assigned_to', to=settings.AUTH_USER_MODEL)),
                ('style_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processes', to='products.style')),
